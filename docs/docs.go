...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/CreateDealRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/RequestChangesRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "DealStatus": {
            ...
            "x-enum-varnames": [
                "DealStatusPendingPayment",
                "DealStatusHoldFailed",
                "DealStatusPendingReview",
                "DealStatusChangesRequested",
                "DealStatusApproved",
                "DealStatusRejected",
                "DealStatusCancelled",
                "DealStatusPosted",
